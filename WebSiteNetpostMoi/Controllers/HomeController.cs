...
namespace WebSite.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult GetImageFromMongoDB(string idmongo, string URLImage)
        {
            try
            {
                if (string.IsNullOrWhiteSpace(idmongo))
                {
                    ...
                    {
                        byte[] imagebytes = client.DownloadData(CommonData.URL_TRANG_CHU + URLImage);
        ...
        public ActionResult tra_cuu_van_don(string hawbNo="")
        {
            ViewData["hawbNo"] = hawbNo;
            return View();
        }

        public ActionResult tra_cuu_cuoc_phi()
        {
            ViewData["_listZone"] = CommonData.GetZone();
            return View();
        }
