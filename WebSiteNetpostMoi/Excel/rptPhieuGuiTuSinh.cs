...
{
    public partial class rptPhieuGuiTuSinh : DevExpress.XtraReports.UI.XtraReport
    {
        public rptPhieuGuiTuSinh()
        {
            InitializeComponent();
        }
        public void SetData(List<CSS_OP_BOOKING_SGEV_WEB_EX> list)
        {
            ...
            {
                xrNguoiGuiKy.Text = xrNguoiGuiKy1.Text = string.Format("{0} h {1} ngày {2} tháng {3} năm {4}",DateTime.Now.ToString("HH"), DateTime.Now.ToString("mm"), DateTime.Now.ToString("dd"), DateTime.Now.ToString("MM"), DateTime.Now.ToString("yyyy"));
            }
        ...
        private void rptPhieuGuiTuSinh_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
